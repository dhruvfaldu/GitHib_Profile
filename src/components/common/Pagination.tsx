    ...
    return (
        <div className="flex items-center justify-center gap-2 mt-5">
            <button
                ...
                disabled={page === 1}
                className={`border border-border text-text px-3 py-2 bg-secondary rounded-xl text-sm sm:text-base hover:border-blue-400 ${page === 1 ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}`}
            >
                Previous
            </button>
            <div className="flex flex-wrap justify-center gap-2">
                {pages.map((p, id) => (
                    <button
                        ...
                        className={`px-3 py-2 rounded-lg border text-sm sm:text-base min-w-9 cursor-pointer
                    ${p === page
            ...
            <button
                ...
                className={`border border-border text-text px-3 py-2 bg-secondary rounded-xl text-sm sm:text-base hover:border-blue-400 ${!hasNextPage ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}`}
            >
                Next
            </button>
        </div>
